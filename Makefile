...
FT = is/ft_isdigit is/ft_isprint is/ft_isalpha is/ft_isascii is/ft_isalnum is/ft_isspace \
    ...
    free/ft_free_char_tab free/ft_free_int_tab \
    ...
    str/ft_substr str/ft_strjoin str/ft_strtrim str/ft_split str/ft_itoa str/ft_strmapi str/ft_striteri str/ft_strcmp str/ft_strtol \
    ...
    printf_fd/printf_fd_utils printf_fd/printf_fd \
